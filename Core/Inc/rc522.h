...
//******************************************************************/
#define PICC_REQIDL               0x26           // The antenna searching area is not in sleep state
#define PICC_REQALL               0x52           // All cards in the antenna searching area
...
#define PICC_AUTHENT1B            0x61           // verification B secret key
...
//******************************************************************/
//                    RC522 Communication returned error code                          /
//******************************************************************/
#define MI_ERR                      0xFE
//#define MI_ERR                         //(-2)
...
extern char KK[8]                                                            ; //  Data encryption key
extern unsigned char RF_Buffer[18]                                           ; //  RF card data buffer
...
extern unsigned char des_on                                                  ; // DES Encryption flag
